...
public class Logic
    ...
    return (double)(0.5*mLength*mWidth);
    }

    public static double rightTrianglePerimeter(double mLength, double mWidth) {
    return (double)(mLength+mWidth+Math.sqrt(Math.pow(mLength,2)+Math.pow(mWidth,2)));
    }
